...
|                          | C: ACCOUNT AT INDEX 0 (SOURCE ACCOUNT) IS WELL-FORMED TOKEN ACCOUNT                                                                                                       |                                            |
|                          | C: SOURCE ACCOUNT IS NOT FROZEN                                                                                                                                           |                                            |
|                          | C: SOURCE ACCOUNT OWNER (ACCOUNT AT INDEX 1) IS SIGNER                                                                                                                    |                                            |
...
|                          | E: UPDATE DESTINATION ACCOUNT BALANCE                                                                                                                                     |                                            |
...
|                          | E: UPDATE SOURCE ACCOUNT BALANCE TO EQUAL ITS RENT-EXEMPT LAMPORTS                                                                                                        |                                            |
...
|                          | C: SOURCE/DESTINATION ACCOUNT TYPE MATCHES                                                                                                                                |                                            |
|                          | C: SOURCE ACCOUNT DELEGATE IS SIGNER AND DELEGATED AMOUNT IS SUFFICIENT OR SOURCE ACCOUNT OWNER IS SIGNER                                                                 |                                            |
|                          | C: SOURCE/DESTINATION ACCOUNT OWNERSHIP (IF SELF-TRANSFER OR ZERO TRANSFER)                                                                                               |                                            |
