...
|                          | C: ACCOUNT AT INDEX 0 (MINT ACCOUNT) IS UNITIALIZED MINT ACCOUNT                                                                                                          |                                            |
|                          | C: MINT ACCOUNT LAMPORTS IS SUFFICIENT FOR RENT-EXEMPTION                                                                                                                 |                                            |
|                          | E: WRITE MINT DATA TO MINT ACCOUNT                                                                                                                                        |                                            |
...
|                          | C: ACCOUNT AT INDEX 0 (TARGET ACCOUNT) IS READY FOR TOKEN ACCOUNT DEPLOY                                                                                                  |                                            |
|                          | C: TARGET ACCOUNT LAMPORTS IS SUFFICIENT FOR RENT-EXEMPTION                                                                                                               |                                            |
|                          | C: ACCOUNT AT INDEX 1 (MINT ACCOUNT) IS OWNED BY PROGRAM (IF MINT ACCOUNT IS NON-NATIVE)                                                                                  |                                            |
|                          | C: MINT ACCOUNT IS WELL-FORMED (IF MINT ACCOUNT IS NON-NATIVE )                                                                                                           |                                            |
|                          | E: COMPUTE TARGET ACCOUNT BALANCE                                                                                                                                         |                                            |
...
|                          | C: REQUIRED SIGNATURES PARAMETER IS A VALID MULTISIG SIGNER ARITY                                                                                                         |                                            |
|                          | E: WRITE MULTISIG ACCOUNT DATA                                                                                                                                            |                                            |
| CloseAccount             | C: ACCOUNT ARITY >= 2                                                                                                                                                     |                                            |
...
|                          | C: SOURCE ACCOUNT CLOSE AUTHORITY OR OWNER IS A SIGNER (IF ACCOUNT NOT OWNED BY SYSTEM/INCINERATOR)                                                                       |                                            |
|                          | C: DESTINATION IS INCINERATOR (IF ACCOUNT IS OWNED BY SYSTEM/INCINERATOR)                                                                                                 |                                            |
...
|                          | C: SOURCE TOKEN ACCOUNT OWNER (ACCOUNT AT INDEX 1) IS SIGNER                                                                                                              |                                            |
|                          | E: ON SOURCE ACCOUNT, CLEAR DELEGATE KEY AND DELEGATED AMOUNT                                                                                                             |                                            |
| Burn                     | C: ACCOUNT ARITY >= 3                                                                                                                                                     |                                            |
|                          | C: ACCOUNT AT INDEX 0 (SOURCE ACCOUNT) IS WELL-FORMED TOKEN ACCOUNT                                                                                                       |                                            |
|                          | C: ACCOUNT AT INDEX 1 (MINT ACCOUNT) IS WELL-FORMED MINT ACCOUNT                                                                                                          |                                            |
|                          | C: SOURCE ACCOUNT IS NOT FROZEN                                                                                                                                           |                                            |
|                          | C: MINT IS NOT NATIVE                                                                                                                                                     |                                            |
|                          | C: SOURCE TOKEN AMOUNT >= BURN AMOUNT                                                                                                                                     |                                            |
|                          | C: SOURCE TOKEN ACCOUNT MINT KEY MATCHES KEY OF MINT ACCOUNT                                                                                                              |                                            |
|                          | C: SOURCE ACCOUNT OWNER OR DELEGATE (ACCOUNT AT INDEX 2) IS SIGNER (IF NOT OWNED BY SYSTEM PROGRAM OR INCINERATOR)                                                        |                                            |
...
|                          | C: DESTINATION TOKEN ACCOUNT MINT KEY MATCHES KEY OF ACCOUNT AT INDEX 0 (MINT ACCOUNT)                                                                                    |                                            |
|                          | C: MINT ACCOUNT IS WELL-FORMED                                                                                                                                            |                                            |
|                          | C: MINT ACCOUNT'S MINT AUTHORITY EXISTS                                                                                                                                   |                                            |
|                          | C: MINT AUTHORITY (ACCOUNT AT INDEX 2) IS SIGNER                                                                                                                          |                                            |
...
|                          | C: SOURCE TOKEN ACCOUNT FROZENNESS DOES NOT MATCH TARGET FROZENNESS                                                                                                       |                                            |
|                          | C: SOURCE TOKEN ACCOUNT IS NOT NATIVE                                                                                                                                     |                                            |
|                          | C: SOURCE TOKEN ACCOUNT MINT KEY MATCHES KEY OF ACCOUNT AT INDEX 1 (MINT ACCOUNT)                                                                                         |                                            |
|                          | C: MINT ACCOUNT IS WELL-FORMED                                                                                                                                            |                                            |
|                          | C: MINT FREEZE AUTHORITY EXISTS                                                                                                                                           |                                            |
|                          | C: MINT FREEZE AUTHORITY (ACCOUNT AT INDEX 2) IS SIGNER                                                                                                                   |                                            |
|                          | E: UPDATE SOURCE TOKEN ACCOUNT TO NEW TARGET FROZENNESS                                                                                                                   |                                            |
...
|                          | C: SOURCE ACCOUNT HAS MORE RENT-EXEMPT LAMPORTS THAN ITS AMOUNT                                                                                                           |                                            |
|                          | E: UPDATE SOURCE TOKEN ACCOUNT BALANCE TO EQUAL ITS RENT-EXEMPT LAMPORTS                                                                                                  |                                            |
| Transfer                 | C: ACCOUNT ARITY >= 2                                                                                                                                                     |                                            |
|                          | C: ACCOUNT AT INDEX 0 (SOURCE TOKEN ACCOUNT) IS WELL-FORMED TOKEN ACCOUNT                                                                                                 |                                            |
|                          | C: ACCOUNT AT INDEX 1 (DESTINATION TOKEN ACCOUNT) IS WELL-FORMED TOKEN ACCOUNT                                                                                            | P-ONLY: Skip if self-transfer              |
|                          | C: SOURCE TOKEN ACCOUNT IS NOT FROZEN                                                                                                                                     |                                            |
|                          | C: DESTINATION TOKEN ACCOUNT IS NOT FROZEN                                                                                                                                | P-ONLY: Skip if self-transfer              |
|                          | C: SOURCE TOKEN AMOUNT >= TRANSFER AMOUNT                                                                                                                                 |                                            |
|                          | C: SOURCE/DESTINATION TOKEN ACCOUNT TYPE MATCHES                                                                                                                          |                                            |
|                          | C: SOURCE TOKEN ACCOUNT DELEGATE IS SIGNER AND DELEGATED AMOUNT IS SUFFICIENT OR SOURCE TOKEN ACCOUNT OWNER IS SIGNER                                                     |                                            |
|                          | C: SOURCE/DESTINATION TOKEN ACCOUNT OWNERSHIP (IF SELF-TRANSFER OR ZERO TRANSFER)                                                                                         |                                            |
...
| TransferChecked          | C: ACCOUNT ARITY >= 3                                                                                                                                                     |                                            |
|                          | C: ACCOUNT AT INDEX 0 (SOURCE TOKEN ACCOUNT) IS WELL-FORMED TOKEN ACCOUNT                                                                                                 |                                            |
|                          | C: ACCOUNT AT INDEX 2 (DESTINATION TOKEN ACCOUNT) IS WELL-FORMED TOKEN ACCOUNT                                                                                            | P-ONLY: Skip if self-transfer              |
|                          | C: SOURCE TOKEN ACCOUNT IS NOT FROZEN                                                                                                                                     |                                            |
|                          | C: DESTINATION TOKEN ACCOUNT IS NOT FROZEN                                                                                                                                | P-ONLY: Skip if self-transfer              |
|                          | C: SOURCE TOKEN AMOUNT >= TRANSFER AMOUNT                                                                                                                                 |                                            |
|                          | C: SOURCE/DESTINATION TOKEN ACCOUNT TYPE MATCHES                                                                                                                          |                                            |
...
|                          | C: SOURCE ACCOUNT OWNER (ACCOUNT AT INDEX 1) IS SIGNER (IF DATA FIELD LENGTH IS TOKEN ACCOUNT SIZE AND AUTHORITY TYPE IS ACCOUNT OWNER)                             |                                            |
|                          | C: NEW ACCOUNT OWNER IS NON-NULL (IF DATA FIELD LENGTH IS TOKEN ACCOUNT SIZE AND AUTHORITY TYPE IS ACCOUNT OWNER)                                                         |                                            |
|                          | E: RESET ACCOUNT DELEGATION STATUS, RESET CLOSE ACCOUNT AUTHORITY, SET NEW ACCOUNT OWNER (IF DATA FIELD LENGTH IS TOKEN ACCOUNT SIZE AND AUTHORITY TYPE IS ACCOUNT OWNER) |                                            |
|                          | C: SOURCE ACCOUNT CLOSER OR OWNER (ACCOUNT AT INDEX 1) IS SIGNER (IF DATA FIELD LENGTH IS TOKEN ACCOUNT SIZE AND AUTHORITY TYPE IS CLOSE ACCOUNT)                   |                                            |
...
|                          | C: MINT AUTHORITY IS NON-NULL AND IS SIGNER ACCOUNT AT INDEX 1 (IF DATA LENGTH IS MINT SIZE AND AUTHORITY TYPE IS MINT AUTHORITY)                                         |                                            |
|                          | E: UPDATE MINT AUTHORITY (IF DATA LENGTH IS MINT SIZE AND AUTHORITY TYPE IS MINT AUTHORITY)                                                                               |                                            |
|                          | C: FREEZE ACCOUNT AUTHORITY IS NON-NULL AND SIGNER ACCOUNT AT INDEX 1 (IF DATA LENGTH IS MINT SIZE AND AUTHORITY TYPE IS FREEZE ACCOUNT)                                  |                                            |
...
|                          | C: MINT ACCOUNT IS WELL-FORMED MINT                                                                                                                                       |                                            |
|                          | E: RETURN TOKEN ACCOUNT LENGTH CONST                                                                                                                                      |                                            |
