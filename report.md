...
|                          | C: MINT AUTHORITY IS NON-NULL AND IS SIGNER ACCOUNT AT INDEX 1 (IF DATA LENGTH IS MINT SIZE AND AUTHORITY TYPE IS MINT TOKENS)                    |                                            |
|                          | E: UPDATE MINT AUTHORITY (IF DATA LENGTH IS MINT SIZE AND AUTHORITY TYPE IS MINT AUTHORITY)                                                       |                                            |
|                          | C: FREEZE ACCOUNT AUTHORITY IS NON-NULL AND IS SIGNER ACCOUNT AT INDEX 1 (IF DATA LENGTH IS MINT SIZE AND AUTHORITY TYPE IS FREEZE ACCOUNT)       |                                            |
