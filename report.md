...
| SyncNative               | C: ACCOUNT ARITY                                                                                                                                                          |                                            |
|                          | C: SOURCE TOKEN ACCOUNT OWNER                                                                                                                                             |                                            |
|                          | C: SOURCE TOKEN ACCOUNT IS WELL-FORMED                                                                                                                                    |                                            |
|                          | C: SOURCE TOKEN ACCOUNT IS NATIVE                                                                                                                                         |                                            |
|                          | C: SOURCE TOKEN ACCOUNT LAMPORTS BALANCE IS SUFFICIENT FOR RENT-EXEMPTION                                                                                                 |                                            |
|                          | C: SOURCE TOKEN ACCOUNT HAS MORE RENT-EXEMPT LAMPORTS THAN ITS RECORDED TOKEN BALANCE                                                                                     |                                            |
|                          | E: UPDATE SOURCE TOKEN ACCOUNT BALANCE TO EQUAL ITS RENT-EXEMPT LAMPORTS                                                                                                  |                                            |
| GetAccountDataSize       | C: ACCOUNT ARITY                                                                                                                                                          |                                            |
|                          | C: SOURCE MINT ACCOUNT OWNER                                                                                                                                              |                                            |
|                          | C: SOURCE MINT ACCOUNT IS WELL-FORMED                                                                                                                                     |                                            |
|                          | E: RETURN ACCOUNT LEN CONST                                                                                                                                               |                                            |
| InitializeMultisig/      | C: ACCOUNT ARITY                                                                                                                                                          |                                            |
| InitializeMUltisig2      | C: RENT ACCOUNT IS WELL-FORMED (IF RENT-SYSVAR-PROVIDED)                                                                                                                  |                                            |
|                          | C: MULTISIG ACCOUNT INDEX CONTAINS DATA FIELD WITH CORRECT LENGTH                                                                                                         |                                            |
|                          | C: MULTISIG ACCOUNT IS NOT INITIALIZED                                                                                                                                    |                                            |
|                          | C: MULTISIG ACCOUNT IS RENT EXEMPT                                                                                                                                        |                                            |
|                          | C: REMAINING ACCOUNT ARITY IS A VALID MULTISIG SIGNER ARITY                                                                                                               |                                            |
|                          | C: REQUIRED SIGNATURES PARAMETER IS A VALID MULTISIG SIGNER ARITY                                                                                                         |                                            |
|                          | E: WRITE MULTISIG ACCOUNT DATA                                                                                                                                            |                                            |
| InitializeImmutableOwner | C: ACCOUNT ARITY                                                                                                                                                          |                                            |
|                          | C: ACCOUNT INFO DATA FIELD IS CORRECTLY SIZED                                                                                                                             |                                            |
|                          | C: ACCOUNT INFO IS NOT INITIALIZED                                                                                                                                        |                                            |
| SetAuthority             | C: ACCOUNT ARITY                                                                                                                                                          |                                            |
|                          | C: SOURCE ACCOUNT IS A WELL-FORMED TOKEN ACCOUNT (IF DATA FIELD LENGTH IS TOKEN ACCOUNT SIZE)                                                                             |                                            |
...
|                          | C: SOURCE TOKEN ACCOUNT OWNER IS SIGNER (IF DATA FIELD LENGTH IS TOKEN ACCOUNT SIZE AND AUTHORITY TYPE IS ACCOUNT OWNER)                                                  |                                            |
...
|                          | C: SOURCE TOKEN ACCOUNT CLOSER OR OWNER IS SIGNER (IF DATA FIELD LENGTH IS TOKEN ACCOUNT SIZE AND AUTHORITY TYPE IS CLOSE ACCOUNT)                                        |                                            |
|                          | E: UPDATE ACCOUNT CLOSER AUTHORITY (IF DATA FIELD LENGTH IS TOKEN ACCOUNT SIZE AND AUTHORITY TYPE IS CLOSE ACCOUNT)                                                       |                                            |
|                          | C: SOURCE ACCOUNT IS WELL-FORMED MINT (IF DATA LENGTH IS MINT SIZE)                                                                                                       |                                            |
|                          | C: AUTHORITY TYPE IS EITHER MINT TOKENS OR FREEZE ACCOUNT (IF DATA LENGTH IS MINT SIZE)                                                                                   |                                            |
|                          | C: MINT AUTHORITY IS NON-NULL AND SIGNER (IF DATA LENGTH IS MINT SIZE AND AUTHORITY TYPE IS MINT AUTHORITY)                                                               |                                            |
|                          | E: UPDATE MINT AUTHORITY (IF DATA LENGTH IS MINT SIZE AND AUTHORITY TYPE IS MINT AUTHORITY)                                                                               |                                            |
|                          | C: FREEZE ACCOUNT AUTHORITY IS NON-NULL AND SIGNER (IF DATA LENGTH IS MINT SIZE AND AUTHORITY TYPE IS FREEZE ACCOUNT)                                                     |                                            |
|                          | E: UPDATE FREEZE ACCOUNT AUTHORITY (IF DATA LENGTH IS MINT SIZE AND AUTHORITY TYPE IS FREEZE ACCOUNT)                                                                     |                                            |
| AmountToUiAmount         | C: ACCOUNT ARITY                                                                                                                                                          |                                            |
|                          | C: SOURCE ACCOUNT OWNER                                                                                                                                                   |                                            |
|                          | C: SOURCE ACCOUNT IS WELL-FORMED MINT                                                                                                                                     |                                            |
|                          | E: RETURN UTF-8 RENDERING OF AMOUNT PARAMTER WITH MINT DECIMALS                                                                                                           |                                            |
| UiAmountToAmount         | C: ACCOUNT ARITY                                                                                                                                                          |                                            |
|                          | C: SOURCE ACCOUNT OWNER                                                                                                                                                   |                                            |
|                          | C: SOURCE ACCOUNT IS WELL-FORMED MINT                                                                                                                                     |                                            |
|                          | E: RETURN U64 AMOUNT FROM RENDERED STRING AMOUNT AND MINT DECIMALS                                                                                                        |                                            |
