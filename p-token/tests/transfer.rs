...
async fn transfer_uninit() {
    ...
    // What should happen 
    // assert_eq!(inner_error, solana_transaction_error::TransactionError::InstructionError(0, solana_instruction::error::InstructionError::UninitializedAccount));
